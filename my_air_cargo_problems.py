...
class AirCargoProblem(Problem):
    ...
    def get_actions(self):
        ...
        however, it is called in the constructor and the results
        cached in the `actions_list` property.
    ...
    def result(self, state: str, action: Action):
        ...
        for possible_action in (possible_action for possible_action in self.actions(state) 
